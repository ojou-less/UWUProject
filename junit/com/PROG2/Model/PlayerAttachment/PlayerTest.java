...
class PlayerTest {
    ...
    @Test
    void addEffect() {
        Player player = new Player(3.2, 4.2, 5.2, 6.2, new CharacterType("advName", "advIcoPath", new Ability(1, 2, "der name", "der iconpath", 1.1, 1.2, 1.3, 1.4,4)), 10, 420);
    ...
    void setClassesType() {
        Player player = new Player(3.2, 4.2, 5.2, 6.2, new CharacterType("advName", "advIcoPath", new Ability(1, 2, "der name", "der iconpath", 1.1, 1.2, 1.3, 1.4,4)), 10, 420);
        player.setClassesType(new CharacterType("advName", "advIcoPath", new Ability(1, 2, "der name", "der iconpath", 1.1, 1.2, 1.3, 1.4,4)));
        assertFalse(player.getClassesType().equals(null));
    }
